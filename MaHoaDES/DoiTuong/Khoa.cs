...
namespace MaHoaDES.DoiTuong
{
    class Khoa
    {
         ...
         /// chúng bao gồm:
         /// - 1 khóa chính ở dạng nhị phân 64bit
        ...
        /// khóa k bị lỗi là khóa có độ dài ko chia hết cho 64
        /// </summary>
        /// <returns></returns>
        ...
        { 
            DayKhoaPhu = new ChuoiNhiPhan[16];// Mảng chứa 16 khóa con 
            ChuoiNhiPhan C0, D0, MotKhoaPhu;
            // b1: tính PC1
            ChuoiNhiPhan[] ChuoiSauPC1 = CacThongSo.TinhPC1(KhoaChinhNhiPhan);
            // sau khi qua PC1 sẽ có 56 bit còn lại được chia thành 2 mảng C0 và D0
            C0 = ChuoiSauPC1[0];
            D0 = ChuoiSauPC1[1];
            ...
            {                
                ...
                // thêm khóa phụ vào mảng khóa con
                DayKhoaPhu[i] = MotKhoaPhu;                         
            }// cứ thế 16 vòng ta thu được 16 khóa con

...
namespace MaHoaDES.DoiTuong
{
    class ChuoiNhiPhan
    {
        ...
        /// <summary>
        /// Hàm tạo lập
        /// tạo mới 1 chuỗi với chiều dài cố định
        /// </summary>
        ...
        /// <summary>
        /// Tạo mới 1 chuỗi biểu diễu 1 ký tự
        /// </summary>
        ...
        /// 1. thêm 64 bit biểu diễn độ dài thực của chuỗi vào cuối chuỗi. để khi giải mã
        ...
        /// <summary>
        /// Chuyển ngược lại nhị phân sang số
        /// </summary>
